...
description: >
  Anti-slop frontend skill for landing pages, portfolios, SaaS dashboards,
  redesigns, UI components, hero sections, pricing sections, testimonials,
  navigation bars, footers, and any frontend implementation. The agent reads
  the brief, infers the design direction, and ships interfaces that do not
  look templated. Real design systems when applicable, audit-first on redesigns,
  strict pre-flight check. Use when building, designing, or styling any
  UI — web pages, apps, components, layouts, or marketing sites.
---
