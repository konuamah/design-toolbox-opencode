  ...
  execute: async () => {
    return {
      ...
      output: [
        ...
        `  • taste-skill — design taste dials: VARIANCE / MOTION / DENSITY`,
        ...
        `  • taste-output — enforce full output, no truncated code or placeholders`,
        "",
        "Detection (Impeccable) + Prevention (Taste) = full design quality loop.",
        "",
